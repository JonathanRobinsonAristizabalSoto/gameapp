...
<section class="scroll">
    <form action="{{ route('games.store') }}" method="POST" enctype="multipart/form-data" class="contenedor_titulos_cajas_register">
        ...
        <section class="contenedor_titulo_caja_register">
            ...
            <div class="caja">
                <input type="text" name="title" placeholder="Enter game title" value="{{ old('title') }}" required>
            </div>
        </section>
        ...
        <section class="contenedor_titulo_caja_register">
            ...
            <div class="caja">
                <input type="date" name="releasedate" value="{{ old('releasedate') }}" required>
            </div>
        </section>
        ...
        <section class="contenedor_titulo_caja_register">
            ...
            <div class="caja">
                <input type="number" name="price" placeholder="Enter game price" value="{{ old('price') }}" step="0.01" required>
            </div>
        </section>
        ...
        <div class="botonregister">
            <button type="submit" class="btn btn-explore">
                <img class="content-btn2-footer" src="{{ asset('images/content-btn-add.svg') }}" alt="Add Game">
            </button>
        </div>
    </form>
</section>
